/*
*   Nombre del programa: sortWords.c
*   Autor: Marco Antonio Esquivel Basaldua
*   Fecha: 16/09/2019
*
*   Descripcion del programa:
*       Lee, guarda y muestra ordenadas por terminal las primeras n (para cambiar este valor ir a la linea 25) palabras
...
int main( int argc , char* argv[] ){
    ...
    int n = 30;     //numero de palabras a leer
